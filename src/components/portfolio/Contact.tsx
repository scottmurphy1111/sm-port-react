        ...
        <div className="row">
          <div className="col-xs-12">
            <div className="special-note fade-item">
              ...
              <p>
                THANK YOU FOR VISITING MY SITE! TO PUT IT SIMPLY, I LOVE TO
                CODE.
              </p>
              <p>
              ...
              <p>
                PLEASE <span className="white-text">CLICK BELOW </span>TO SEND
            ...
            <div className="block fade-item">
              <h2 className="category-title">{contactTitle}</h2>
